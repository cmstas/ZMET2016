...
void METStudy(TString save_dir = "~/public_html/ZMET2016/plots/MET_study/")
{
  ...
  plot_vars.push_back("phpfcands_2530_pt");
  ...
  // Neutral Hadron MET Phi in Forward Calorimeter (|eta| > 3)
  plot_names.push_back("nu_30in_phi");
  plot_vars.push_back("nupfcands_30in_phi");
