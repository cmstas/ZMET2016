...
# ./writeConfig_80X.sh /hadoop/cms/store/group/snt/run2_data/Run2016B_SinglePhoton_MINIAOD_PromptReco-v1/merged/V08-00-04/ ${TAG}_data_2016B_Prompt_ph_v1_brokentrigs
...
# ./writeConfig_80X.sh /hadoop/cms/store/group/snt/run2_data/Run2016B_SinglePhoton_MINIAOD_PromptReco-v2/merged/V08-00-04/ ${TAG}_data_2016B_Prompt_ph_v2_brokentrigs
...
# ./writeConfig_80X.sh /${hadoopdirv2}/GJets_DR-0p4_HT-400To600_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_${miniaodv2}_v0-v1/V08-00-05/new_xsec/ ${TAG}_gjetsht400_dr0p4_mgmlm
# ./writeConfig_80X.sh /${hadoopdirv2}/GJets_DR-0p4_HT-600ToInf_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_${miniaodv2}_v0-v1/V08-00-05/new_xsec/ ${TAG}_gjetsht600_dr0p4_mgmlm
