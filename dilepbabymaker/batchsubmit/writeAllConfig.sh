...
# ./writeConfig_80X.sh /${hadoopdirv2}/TTJets_DiLept_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_${miniaodv2}_v0_ext1-v1/V08-00-05/        ${TAG}_ttbar_dilep_mgmlm_ext
# ./writeConfig_80X.sh /${hadoopdirv2}/TTTo2L2Nu_TuneCUETP8M1_alphaS01273_13TeV-powheg-pythia8_${miniaodv2}_v0-v1/V08-00-05/          ${TAG}_ttbar_dilep_powheg_alphas01273

# # single top
# ./writeConfig_80X.sh /${hadoopdirv2}/ST_t-channel_top_4f_leptonDecays_13TeV-powheg-pythia8_TuneCUETP8M1_${miniaodv2}_v0-v1/V08-00-05/     ${TAG}_stt_top_lepdec_powheg
# ./writeConfig_80X.sh /${hadoopdirv2}/ST_t-channel_antitop_4f_leptonDecays_13TeV-powheg-pythia8_TuneCUETP8M1_${miniaodv2}_v0-v1/V08-00-05/ ${TAG}_stt_antitop_lepdec_powheg
# ./writeConfig_80X.sh /${hadoopdirv2}/ST_tW_top_5f_NoFullyHadronicDecays_13TeV-powheg_TuneCUETP8M1_${miniaodv2}_v0-v1/V08-00-05/           ${TAG}_sttw_antitop_nofullhaddecay_powheg
# ./writeConfig_80X.sh /${hadoopdirv2}/ST_tW_antitop_5f_NoFullyHadronicDecays_13TeV-powheg_TuneCUETP8M1_${miniaodv2}_v0-v1/V08-00-05/	      ${TAG}_sttw_top_nofullhaddecay_powheg	  
...
# ./writeConfig_80X.sh /${hadoopdirv2}/TTZToLLNuNu_M-10_TuneCUETP8M1_13TeV-amcatnlo-pythia8_RunIISpring16MiniAODv2-premix_withHLT_80X_mcRun2_asymptotic_v14_ext1-v1/V08-00-12/ ${TAG}_ttz_2l2n_amcnlo_ext
...
# ./writeConfig_80X.sh /${hadoopdirv2}/WJetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_${miniaodv2}_v0-v1/V08-00-05/                    ${TAG}_wjets_incl_mgmlm
...
# ./writeConfig_80X.sh /${hadoopdirv2}/TTGJets_TuneCUETP8M1_13TeV-amcatnloFXFX-madspin-pythia8_RunIISpring16MiniAODv2-PUSpring16_80X_mcRun2_asymptotic_2016_miniAODv2_v0-v1/V08-00-05/            ${TAG}_ttgamma_incl_amcnlo
...
# ./writeConfig_80X.sh /${hadoopdirv2}/GJets_HT-40To100_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_${miniaodv2}_v0-v1/V08-00-05/  ${TAG}_gjetsht40_dr0p05_mgmlm 
# ./writeConfig_80X.sh /${hadoopdirv2}/GJets_HT-100To200_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_${miniaodv2}_v0-v4/V08-00-05/ ${TAG}_gjetsht100_dr0p05_mgmlm
# ./writeConfig_80X.sh /${hadoopdirv2}/GJets_HT-200To400_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_${miniaodv2}_v0-v1/V08-00-05/ ${TAG}_gjetsht200_dr0p05_mgmlm
