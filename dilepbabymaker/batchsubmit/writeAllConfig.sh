...
# ./writeConfig_80X.sh /${hadoopdirv2}/TTGJets_TuneCUETP8M1_13TeV-amcatnloFXFX-madspin-pythia8_${miniaodv2}_v0-v1/V08-00-05/      ${TAG}_ttg_incl_mgmlm
...
# # VVV
# ./writeConfig_80X.sh /${hadoopdirv2}/WWW_4F_TuneCUETP8M1_13TeV-amcatnlo-pythia8_${miniaodv2}_v0-v1/V08-00-05/ ${TAG}_www_incl_mgmlm
# ./writeConfig_80X.sh /${hadoopdirv2}/WWZ_TuneCUETP8M1_13TeV-amcatnlo-pythia8_${miniaodv2}_v0-v1/V08-00-05/    ${TAG}_wwz_incl_mgmlm
